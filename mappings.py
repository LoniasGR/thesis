...
list_of_functionalities = ["icu_stats_form", "vaccine_stats_form", "covid_statistics_form", 
                           "pharmacy_form", "ill_questionnaire_form", "ways_of_protection", "symptoms", 
                           "test_types", "test_cost", "what_to_do_if_positive", 
                           "underlying_conditions", "no_action"]
